    ...
    <body>
        ...
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
                ...
                <img src="/Pineapple/images/1.jpg" style="-webkit-transform: translate(0, -150px);" >
                <div class="text">pPhone 7</div>
            </div>

            <div class="mySlides fade">
                <div class="numbertext">2 / 3</div>
                <img src="/Pineapple/images/2.jpg" style="-webkit-transform: translate(0, -150px);" >
                <div class="text">Caption Two</div>
            </div>

            <div class="mySlides fade">
                <div class="numbertext">3 / 3</div>
                <img src="/Pineapple/images/3.jpg" style="-webkit-transform: translate(0, 150px);" >
